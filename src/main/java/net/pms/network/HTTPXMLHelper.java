...
class HTTPXMLHelper {
	...
	static final String RESULT_HEADER = "<Result xmlns:dt=\"urn:schemas-microsoft-com:datatypes\" dt:dt=\"string\">";
	static final String RESULT_FOOTER = "</Result>";
	static final String DIDL_HEADER = "&lt;DIDL-Lite xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xmlns:upnp=\"urn:schemas-upnp-org:metadata-1-0/upnp/\" xmlns=\"urn:schemas-upnp-org:metadata-1-0/DIDL-Lite/\" xmlns:microsoft=\"urn:schemas-microsoft-com:WMPNSS-1-0/\" xmlns:dlna=\"urn:schemas-dlna-org:metadata-1-0/\" xmlns:sec=\"http://www.sec.co.kr/\" xmlns:pv=\"http://www.pv.com/pvns/\"&gt;";
